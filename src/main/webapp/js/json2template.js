...
(function ($)
{
    ...
    $.json2template =
    {
        ...
        execute: function (item, template, placeHolder)
        {
            ...
            var $ = Zepto, _this = $.json2template, settings = _this.settings
        ...
        {
            return Zepto.trim(str).match("^"+val)==val;
        },
...
$.merge = function(array1, array2){
    for( var i = 0; i<array2.length; i++ ){
            ...
            array1[ length ] = array2[i];
            array1.length = length + 1;
    }
    return array1;
}
